...
globalRouter.route("/join").all(onlyPublicMiddleware).get(getJoin).post(postJoin);
globalRouter.route("/login").all(onlyPublicMiddleware).get(getLogin).post(postLogin);
